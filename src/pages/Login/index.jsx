      ...
      <div className="login__home">
        ...
        <div className="login__down">
          <div className="login__down--input">
            ...
            <div className="input__box"><i className="fas fa-user"/><input placeholder={t('Login:Type_your_mail', 'Digite su e-mail')}/></div>
            <p className="input--title">{t('Login:Password', 'Contraseña')}</p>
            <div className="input__box"><i className="fas fa-lock"/><input placeholder={t('Login:Type_your_password', 'Digite su contraseña')}/></div>
          </div>
